...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="application-name" content="JourneyJotter" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="JourneyJotter" />
      ...
      />
      <body
        className={`${plusJakartaSans.className} antialiased bg-background mx-auto`}
      >
        {children}
      </body>
    </html>
